    ...
    <section className="mt-12">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4">
        {history.map((item) => (
          <div 
            key={item.id} 
            className="group aspect-square bg-slate-800 rounded-lg overflow-hidden cursor-pointer relative shadow-lg hover:shadow-brand-500/30 transition-all duration-300 transform hover:scale-105"
